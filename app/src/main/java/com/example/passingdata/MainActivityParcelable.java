    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Rizki Arya Ramadhan");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 18);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Rizki Arya Ramadhan");
                mPerson.setAge(18);
                mPerson.setEmail("Rizki.ar024@gmai.com");
